...
class ActionServer:
    ...
    def serve_actions(self, itr):
        ...
        if "bootstrap_value" in self.samples_np.agent:
            self.samples_np.agent.bootstrap_value[:], self.samples_np.agent.bootstrap_value_int[:], self.samples_np.agent.bootstrap_value_ext_prime[:] = self.agent.value(*agent_inputs)
            # print(self.samples_np.agent.bootstrap_value_ext_prime[:].shape, self.samples_np.agent.bootstrap_value[:].shape)
